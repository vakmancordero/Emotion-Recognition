...
public class TestOCV {
    ...
    public TestOCV(int numFeatures, int size) throws URISyntaxException {
        
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        
        this.classifier = new CascadeClassifier(
                "C:\\Users\\VakSF\\Desktop\\EmotionClient\\src\\emotion\\xml\\haarcascade_frontalface_default.xml"
        );
        
        this.svmClassifier = new LibSVM(numFeatures);
        
        this.svmClassifier.load("data.bin");
    ...
    public void generateVectors() throws URISyntaxException, IOException {
        ...
        for (File file : this.getFile("/emotion/image").listFiles()) {
            
            String fileName = file.getName();
            
            Mat scarface = this.getScarface("/emotion/image/" + fileName);
    ...
    public void renameFiles() throws URISyntaxException, IOException {
        ...
        for (File folder : this.getFile("/emotion/image").listFiles()) {
    ...
    public void handTraining() throws URISyntaxException {
        ...
        for (File file : this.getFile("/emotion/data/train").listFiles()) {
            
            String fileName = file.getName();
            
            Mat image = Imgcodecs.imread(getPath(
                    "/emotion/data/train/" + fileName));
    ...
    public void facesTraining() throws URISyntaxException {
        ...
        for (File folder : new File(
                "C:\\Users\\VakSF\\Desktop\\EmotionClient\\src\\emotion\\image"
        ).listFiles()) {
                ...
                if (!folderName.equalsIgnoreCase("training")) {
                    ...
                    for (File file : folder.listFiles()) {
                        ...
                        Mat scarface = this.getScarface(
                                "C:\\Users\\VakSF\\Desktop\\EmotionClient\\src\\emotion\\image\\" + folderName + "\\" + file.getName());
        ...
        this.svmClassifier.save("data.bin");
        
        System.out.println("Ok - Faces");
    ...
    public Mat getScarface(String fileName) throws URISyntaxException {
    ...
    public Mat getScarface(File file) {
        
        Mat image = Imgcodecs.imread(getPathFromFile(file));
        MatOfRect facesRect = new MatOfRect();
